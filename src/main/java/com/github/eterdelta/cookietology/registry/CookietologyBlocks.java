...
public class CookietologyBlocks {
    ...
    public static final RegistryObject<Block> BAKER = BLOCKS.register("baker", () -> new BakerBlock(BlockBehaviour.Properties.of(Material.HEAVY_METAL).sound(SoundType.METAL).requiresCorrectToolForDrops().strength(3.5F)));
