...
import com.github.eterdelta.cookietology.block.entity.BakerBlockEntity;
...
public class CookietologyBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<BakerBlockEntity>> BAKER = BLOCK_ENTITIES.register("baker", () -> BlockEntityType.Builder.of(BakerBlockEntity::new, CookietologyBlocks.BAKER.get()).build(null));
